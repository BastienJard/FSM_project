...
package fr.univcotedazur.polytech.si4.fsm.project.recipe;
...
public class RecipeMachineStatemachine implements IStatemachine, ITimed {
	public enum State {
		MAIN_REGION_BEGINNINGRECIPE,
	...
	public RecipeMachineStatemachine() {
		for (int i = 0; i < 2; i++) {
	...
	private void runCycle() {
		...
		do { 
			for (nextStateIndex = 0; nextStateIndex < stateVector.length; nextStateIndex++) {
				...
				case MAIN_REGION_BEGINNINGRECIPE:
					main_region_beginningRecipe_react(true);
					break;
			...
			clearInEvents();
			nextEvent();
		} while (((((((beginRecipe || timeEvents[0]) || timeEvents[1]) || timeEvents[2]) || timeEvents[3]) || timeEvents[4]) || timeEvents[5]));
	...
	*/
	public synchronized boolean isStateActive(State state) {
		...
		switch (state) {
		case MAIN_REGION_BEGINNINGRECIPE:
			return stateVector[0] == State.MAIN_REGION_BEGINNINGRECIPE;
	...
	protected void raiseStep1() {
		synchronized(RecipeMachineStatemachine.this) {
			step1 = true;
			step1Observable.next(null);
		}
	}
	
	private Observable<Void> step1Observable = new Observable<Void>();
	
	public Observable<Void> getStep1() {
		return step1Observable;
	}
	
	private boolean step2;
	
	
	protected void raiseStep2() {
		synchronized(RecipeMachineStatemachine.this) {
			step2 = true;
			step2Observable.next(null);
		}
	}
	
	private Observable<Void> step2Observable = new Observable<Void>();
	
	public Observable<Void> getStep2() {
		return step2Observable;
	}
	
	private boolean step3;
	
	
	protected void raiseStep3() {
		synchronized(RecipeMachineStatemachine.this) {
			step3 = true;
			step3Observable.next(null);
		}
	}
	
	private Observable<Void> step3Observable = new Observable<Void>();
	
	public Observable<Void> getStep3() {
		return step3Observable;
	}
	
	private boolean step4;
	
	
	protected void raiseStep4() {
		synchronized(RecipeMachineStatemachine.this) {
			step4 = true;
			step4Observable.next(null);
		}
	}
	
	private Observable<Void> step4Observable = new Observable<Void>();
	
	public Observable<Void> getStep4() {
		return step4Observable;
	}
	
	private boolean step5;
	
	
	protected void raiseStep5() {
		synchronized(RecipeMachineStatemachine.this) {
			step5 = true;
			step5Observable.next(null);
		}
	}
	
	private Observable<Void> step5Observable = new Observable<Void>();
	
	public Observable<Void> getStep5() {
		return step5Observable;
	}
	...
	private void enterSequence_main_region_beginningRecipe_default() {
		nextStateIndex = 0;
		stateVector[0] = State.MAIN_REGION_BEGINNINGRECIPE;
	}
	...
	/* Default exit sequence for state beginningRecipe */
	private void exitSequence_main_region_beginningRecipe() {
		nextStateIndex = 0;
	...
	private void exitSequence_main_region() {
		...
		case MAIN_REGION_BEGINNINGRECIPE:
			exitSequence_main_region_beginningRecipe();
			break;
		case MAIN_REGION_PREPAREDRINK__REGION0_STEP1:
	...
	private void react_main_region__entry_Default() {
		enterSequence_main_region_beginningRecipe_default();
	}
	...
	private boolean main_region_beginningRecipe_react(boolean try_transition) {
